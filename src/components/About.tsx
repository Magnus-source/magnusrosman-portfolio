      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-[300px_1fr] lg:grid-cols-[400px_1fr] gap-12 items-start">
          ...
          <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
            ...
            <p>When he's not behind the camera directing commercials or drama series, Magnus produces olive oil at his small estate, <strong>Collinadolce</strong>, on the Italian east coast. He also gives talks on creativity, including his recent presentation <strong>"The Power of Constraints: How Frameworks Unleash Creativity."</strong></p>
          </div>
        </div>
      </div>
    </section>;
