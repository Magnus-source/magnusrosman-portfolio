      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-[300px_1fr] lg:grid-cols-[400px_1fr] gap-12 items-start">
          ...
          <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
            <p>Since 1999 Magnus Rösman has created catchy commercials, music videos, tv-series and documentaries with a warm human touch often finding the laugh in life's mishaps.</p>
