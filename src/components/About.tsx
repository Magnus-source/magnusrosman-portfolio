      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-[300px_1fr] lg:grid-cols-[400px_1fr] gap-12 items-start">
          ...
          <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
            ...
            <p>Magnus developed an unrivaled ability to create funny characters and efficient dialogue as the director behind the iconic <strong>ICA commercials</strong> featuring ICA-Stig and his colleagues. Over a 5-year period, he wrote and directed more than 100 commercial films for ICA, Sweden's largest supermarket chain, earning multiple Swedish and international advertising awards and establishing one of Sweden's most recognized ad campaigns.</p>
